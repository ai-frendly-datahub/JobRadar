...
_ACTIVE_THROTTLER: Any = None
_ACTIVE_HEALTH_STORE: Any = None
...
def collect_sources(
    ...
    *,
    ...
    throttler_cls, health_store_cls = _load_radar_core_classes()
    ...
    try:
        ...
        if js_sources:
            ...
            browser_articles, browser_errors = collect_browser_sources(
                js_sources,
                category,
